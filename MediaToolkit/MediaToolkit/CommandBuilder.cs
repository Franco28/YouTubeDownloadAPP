    ...
    internal class CommandBuilder
    {
        ...
        private static string Convert(MediaFile inputFile, MediaFile outputFile, ConversionOptions conversionOptions)
        {
            ...
            if (conversionOptions == null)
                return commandBuilder.AppendFormat(" -i \"{0}\" -movflags use_metadata_tags -map_metadata 0 \"{1}\" ", inputFile.Filename, outputFile.Filename).ToString();
            ...
            commandBuilder.AppendFormat(" -i \"{0}\" -movflags use_metadata_tags -map_metadata 0 ", inputFile.Filename);
