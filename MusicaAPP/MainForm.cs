...
namespace YouTubeDownload
{
    public partial class MainForm : Form
    {
        ...
        public void SetAlbumArt(string path, TagLib.File file)
        {
        ...
        private void SaveMP3()
        {
            ...
            try
            {
                ...
                if (radioButton4K.Checked == true)
                {
                    conversionOptions = new ConversionOptions
                    {
                        AudioBitRate = 320,
                        VideoFps = 60,
                        VideoSize = VideoSize._4K
                    };
                }
                ...
                using (var engine = new Engine())
                {
                    ...
                    labelEstado.Text = "Estado: Agregando metadata a la canción...";
                    UpdateProgress(80);
            ...
            MessageBox.Show("Listo! Se convirtió y se descargó la canción " + MP3Name + " y se guardó en " + downloadPath, "Canción procesada correctamente!", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void DescargarMusica_Load(object sender, EventArgs e)
        {
            ...
            // Verifico OTA
            AutoUpdater.Start("https://raw.githubusercontent.com/Franco28/YouTubeDownloadAPP/main/ota.xml");
        }
        ...
        private void radioButtonGuardarVideoSi_CheckedChanged(object sender, EventArgs e)
        {
            groupBoxResolucionVideo.Hide();
        }

        private void radioButtonGuardarVideoNo_CheckedChanged(object sender, EventArgs e)
        {
            groupBoxResolucionVideo.Hide();
        }
